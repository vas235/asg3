...
local file = "O:\7 SURVEYS\NSCH\10 Shared\MCHB\2023 Preliminary Results"
*************************************************************
*************************************************************

*use "`file'\nsch_2023e_topical", clear
use "`file'\topical_puf", clear
...
label var decisions_r  "Health Care Decisions Needed"
...
label var gowhensick  "Place Usually Goes Sick - Where"
...
label var a1_employed_r  "Adult 1 - Current Employment Status"
label var a2_employed_r  "Adult 2 - Current Employment Status"
...
label var height  "Child's Height (CM)"
label var weight  "Child's Weight (KG)"
...
label define a1_employed_r_lab  1  "Employed full-time"
    label define a1_employed_r_lab  2  "Employed part-time", add
    label define a1_employed_r_lab  3  "Working WITHOUT pay", add
    label define a1_employed_r_lab  4  "Not employed but looking for work", add
    label define a1_employed_r_lab  5  "Not employed and not looking for work", add
    label define a1_employed_r_lab  6  "Retired", add
    label define a1_employed_r_lab  .m "No valid response", add
    label define a1_employed_r_lab  .n "Not in universe", add
    label define a1_employed_r_lab  .l "Logical skip", add
    label define a1_employed_r_lab  .d "Suppressed for confidentiality", add
cap label values a1_employed_r a1_employed_r_lab
...
label define a2_employed_r_lab  1  "Employed full-time"
    label define a2_employed_r_lab  2  "Employed part-time", add
    label define a2_employed_r_lab  3  "Working WITHOUT pay", add
    label define a2_employed_r_lab  4  "Not employed but looking for work", add
    label define a2_employed_r_lab  5  "Not employed and not looking for work", add
    label define a2_employed_r_lab  6  "Retired", add
    label define a2_employed_r_lab  .m "No valid response", add
    label define a2_employed_r_lab  .n "Not in universe", add
    label define a2_employed_r_lab  .l "Logical skip", add
    label define a2_employed_r_lab  .d "Suppressed for confidentiality", add
cap label values a2_employed_r a2_employed_r_lab
...
label define decisions_r_lab  1  "Yes"
    label define decisions_r_lab  2  "No", add
    label define decisions_r_lab  .m "No valid response", add
    label define decisions_r_lab  .n "Not in universe", add
    label define decisions_r_lab  .l "Logical skip", add
    label define decisions_r_lab  .d "Suppressed for confidentiality", add
cap label values decisions_r decisions_r_lab
...
label define gowhensick_lab  1  "Doctor's Office"
    label define gowhensick_lab  2  "Hospital Emergency Room", add
    label define gowhensick_lab  3  "Hospital Outpatient Department", add
    label define gowhensick_lab  8  "Urgent Care Center", add
    label define gowhensick_lab  5  "Clinic within a drug store or grocery store", add
    label define gowhensick_lab  6  "School (Nurse's Office, Athletic Trainer's Office)", add
    label define gowhensick_lab  4  "Other Clinic or Health Center", add
    label define gowhensick_lab  7  "Some other place", add
    label define gowhensick_lab  .m "No valid response", add
    label define gowhensick_lab  .n "Not in universe", add
    label define gowhensick_lab  .l "Logical skip", add
    label define gowhensick_lab  .d "Suppressed for confidentiality", add
cap label values gowhensick gowhensick_lab
...
label define placeslived_lab  1  "0-2 places"
    label define placeslived_lab  2  "3 or more places", add
...
label define a1_age_lab 70 "70 or older", add
label define a2_age_lab 70 "70 or older", add
...
label define k11q43r_lab 10 "10 or more", add
